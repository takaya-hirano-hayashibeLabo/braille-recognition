...
DATA_ROOT_NAME="test_data_32x32"
RAW_DIR_NAME="original"
CONVERTED_DIR_NAME="3d_data"

python ./do_simulation.py --dot_shape default --episode_num 10 --touch_sensor_num 32  --save_dir "${DATA_ROOT_NAME}/${RAW_DIR_NAME}"  --is_handy_random
